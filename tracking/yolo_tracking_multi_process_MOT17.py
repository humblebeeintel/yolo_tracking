...
def process_sequence(seq_path, args, gpu_id):
    ...
    try:
        ...
        args.project = os.path.join('/workspace/LiteSORT/yolo_tracking/hbai_scripts/MOT17-train', f"{args.tracking_method}__input_1280__conf_.25")
...
if __name__ == '__main__':
    ...
    source_path = '/workspace/LiteSORT/datasets/MOT17/train'
